 ...
 * Optimized for Slider and View More functionality
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 3. Certificate Slider Logic (Using Smooth ScrollBy) ---
    ...
    if (certSlider && nextCertBtn && prevCertBtn) {
        console.log("Certificate Slider Buttons Initialized");
    ...
    // --- 4. Projects "View More" Logic (Event Delegation) ---
    document.addEventListener('click', function(e) {
        if (e.target && e.target.id === 'view-more-projects') {
            ...
            e.target.parentElement.classList.add('hidden'); // Hides the button container
        }
    });
